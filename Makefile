...
.PHONY: help install run backend frontend docker-up docker-down docker-build clean
...
clean: ## Remove generated data, caches, and temp files
	find . -type d -name __pycache__ -exec rm -rf {} + 2>/dev/null || true
	find . -type f -name "*.pyc" -delete 2>/dev/null || true
	rm -rf data/faiss_index/
	@echo "Cleaned caches and FAISS index."
